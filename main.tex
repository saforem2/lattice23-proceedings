...
%
This phenomenon can be seen in Fig~\fig{fig:csd}, where fluctuations in the topological charge $\delta Q = |Q^{i + \ell} - Q^{i}|$ decrease as $\beta = 2 \rightarrow 3 \rightarrow \cdots$, and disappear completely by $\beta = 7$.
%
...
\begin{wrapfigure}[16]{r}{0.5\textwidth}
  \begin{center}
  %\vspace{-25pt}
  \includesvg[width=0.5\textwidth]{assets/critical_slowing_down}
  \end{center}
