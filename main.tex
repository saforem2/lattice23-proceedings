...
%
%
\begin{wrapfigure}[18]{l}{0.40\textwidth}
  \begin{center}
...
\begin{figure}[htpb!]
    ...
    \begin{subfigure}{0.65\textwidth}
        ...
        \includesvg[width=\textwidth]{assets/2dU1/loss_dQint_train_pt.svg}
        \caption{\label{subfig:loss_dQint}Loss and $\delta Q$ during Training for 2D $U(1)$ model.}
    \end{subfigure}
    %
    \hfill
    %
    ...
    \begin{subfigure}{0.31\textwidth}
        ...
        \includesvg[width=\textwidth]{assets/2dU1/logdet_rp_eval_pt.svg}
        \caption{\label{subfig:logdet2dU1}$|\mathcal{J}|\, (\coloneqq\texttt{logdet})$ vs LF step.}
    \end{subfigure}
    %
    \hfill
    %
    \begin{subfigure}{0.31\textwidth}
        % \includesvg[width=\textwidth]{assets/logdet_ridgeplot1.svg}
        \includesvg[width=\textwidth]{assets/2dU1/energy_rp_eval_pt.svg}
        \caption{\label{subfig:energy2dU1}Energy $(\coloneqq H)$ vs LF step}
    \end{subfigure}
    %
    \hfill
    %
