...
%
\begin{wrapfigure}[20]{O}{0.50\textwidth}
  \begin{center}
...
\end{wrapfigure}
%
Building on the approach from~\cite{L2HMC,FTHMC,etc}, we introduce two (invertible) neural networks (\texttt{xNet}, \texttt{vNet}):
%
\begin{align}
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Construct initial state $\xi = (x, v)$
    \end{itemize}
...
%
Similarly, we can write the Hamiltonian as
%
\begin{equation}
